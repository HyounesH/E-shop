...
<style type="text/css">
<%@
include file ="./style/bootstrap.css" %> h4 {
	color: white;
	letter-spacing: 5px;
...
<body>
	...
	<div class="container">
        <div class="jumbotron" style="border-raduis:none;">
        <ul>
        <li><i>Commande :</i> <span>${numero_cmd }</span></li>
        <li><i>Date Commande :</i><span>${date_cmd }</span></li>
        <li><i>Montant HT :</i><span>${montant_cmd }</span></li>
        </ul>
        </div>
		<div class="well article_title" style="background-color: lightblue;">
			<h4>
				<i>Liste des Articles commandés</i>
			</h4>
			<hr>
		</div>
